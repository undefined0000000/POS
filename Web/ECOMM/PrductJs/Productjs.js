...
function showADDBrand() {
    var view = document.getElementById('ContentPlaceHolder1_pnlbrand');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDBarcodePrint() {
    var view = document.getElementById('ContentPlaceHolder1_pnlBarcodePrint');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDColors() {
    var view = document.getElementById('ContentPlaceHolder1_pnlcolor');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDSize() {
    var view = document.getElementById('ContentPlaceHolder1_pnlsize');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDUOM() {
    var view = document.getElementById('ContentPlaceHolder1_pnlUOM');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDMULTUOM() {
    var view = document.getElementById('ContentPlaceHolder1_PNLUOMMULTI');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function showADDCategory() {
    var view = document.getElementById('ContentPlaceHolder1_pnlcategary');
    if (view.style.display == "none") {
        view.style.display = "block";
        view1.value = "Hide";
    }
...
function ShowImagInuploadimg(va) {
    if (va == "ImaMain") {
        document.getElementById("ContentPlaceHolder1_panelAllImg").style.display = "none";
        document.getElementById("ContentPlaceHolder1_pnelMainImag").style.display = "block";
