...
var KTAppInbox = function() {
    ...
    var initForm = function(formEl) {
        ...
        var tagifyTo = new Tagify(toEl, {
            ...
            whitelist: [{
                ...
                initials: '',
                initialsState: '',
                pic: './assetsp/media/users/100_11.jpg',
                ...
                value: 'Alon Silko',
                email: 'alon@pos53.com',
                initials: '',
                initialsState: '',
                pic: './assetsp/media/users/100_6.jpg'
            }, {
                value: 'Sam Seanic',
                email: 'sam.senic@loop.com',
                initials: '',
                initialsState: '',
                pic: './assetsp/media/users/100_8.jpg'
            }, {
                value: 'Sara Loran',
                email: 'sara.loran@tilda.com',
                initials: '',
                initialsState: '',
                pic: './assetsp/media/users/100_9.jpg'
            }, {
                value: 'Eric Davok',
                email: 'davok@mix.com',
                initials: '',
                initialsState: '',
                pic: './assetsp/media/users/100_13.jpg'
            }, {
                value: 'Sam Seanic',
                email: 'sam.senic@loop.com',
                initials: '',
                ...
                pic: './assetsp/media/users/100_15.jpg'
            }],
            templates: {
    ...
    var initAttachments = function(elemId) {
        ...
        var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
            url: "https://pos53.com/scripts/void.php", // Set the url for your upload script location
            parallelUploads: 20,
