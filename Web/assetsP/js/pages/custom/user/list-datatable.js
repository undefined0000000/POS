...
var KTUserListDatatable = function() {
	...
	// init
	var init = function() {
		// init the datatables. Learn more: https://pos53.com/metronic/?page=docs&section=datatable
		datatable = $('#kt_apps_user_list_datatable').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						url: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/datatables/demos/default.php',
					},
				},
					...
					if (number > 5) {
						output = '<div class="kt-user-card-v2">\
								<div class="kt-user-card-v2__pic">\
									<img src="https://pos53.com/metronic/preview/assetsp/media/users/' + user_img + '" alt="photo">\
								</div>\
				...
				template: function(data, i) {
					...
					var output = '\
                        <div class="kt-user-card-v2">\
                            <div class="kt-user-card-v2__pic">\
                                <img src="https://pos53.com/metronic/preview/assetsp/media/client-logos/logo' + img + '" alt="photo">\
                            </div>\
                            <div class="kt-user-card-v2__details">\
