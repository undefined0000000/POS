	...
	var demo = function() {
		...
		var datatable = $('.kt-datatable').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						url: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/datatables/demos/customers.php',
					},
				},
		...
		function subTableInit(e) {
			$('<div/>').attr('id', 'child_data_ajax_' + e.data.RecordID).appendTo(e.detailCell).KTDatatable({
				data: {
					...
					source: {
						read: {
							url: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/datatables/demos/orders.php',
							params: {
								// custom query params
								query: {
									generalSearch: '',
