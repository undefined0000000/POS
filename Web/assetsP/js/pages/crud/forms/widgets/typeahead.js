...
var KTTypeahead = function() {
    ...
    var demo3 = function() {
        var countries = new Bloodhound({
            ...
            prefetch: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/typeahead/countries.json'
        });
    ...
    var demo4 = function() {
        var bestPictures = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/typeahead/movies.json'
        });
    ...
    var demo5 = function() {
        var nbaTeams = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/typeahead/nba.json'
        });

        var nhlTeams = new Bloodhound({
            datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/typeahead/nhl.json'
        });
