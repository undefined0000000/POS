...
```js
import 'owl.carousel/dist/assetsp/owl.carousel.css';
import 'owl.carousel';
```
...
```html
<link rel="stylesheet" href="/node_modules/owl.carousel/dist/assetsp/owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="/bower_components/owl.carousel/dist/assetsp/owl.carousel.min.css" />
```
