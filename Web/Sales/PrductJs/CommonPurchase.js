...
//}
function showhidepanelItems(va) {
    if (va == "OHCOST") {
        document.getElementById("ContentPlaceHolder1_step3").style.display = "block";
        document.getElementById("ContentPlaceHolder1_step4").style.display = "none";
        document.getElementById("ContentPlaceHolder1_step5").style.display = "none";

    }
    else if (va == "ITEMS") {
        document.getElementById("ContentPlaceHolder1_step3").style.display = "none";
        document.getElementById("ContentPlaceHolder1_step4").style.display = "block";
        document.getElementById("ContentPlaceHolder1_step5").style.display = "none";
    }
    else if (va == "Reference") {
        document.getElementById("ContentPlaceHolder1_step3").style.display = "none";
        document.getElementById("ContentPlaceHolder1_step4").style.display = "none";
        document.getElementById("ContentPlaceHolder1_step5").style.display = "block";
    }
}