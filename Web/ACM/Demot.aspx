<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Demot.aspx.cs" Inherits="Web.ACM.Demot" %>
...
<body>
    ...
    <div>
    <iframe runat="server" id="urIframe"   height="700" frameborder="0" width="100%"></iframe>
    </div>
    </form>
</body>
</html>--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital Edge Solutions</title>
    ...
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                <div class="page-header navbar navbar-fixed-top">
                    ...
                    <div class="page-header-inner">
                        ...
                        <div class="page-logo">
                            <a href="index.html">
                                <img src="http://www.erp53.com/ECOMM/Upload/DELogoOnly.jpg" alt="logo" class="logo-default" style="width: 20%;" />
                            </a>
                                ...
                                <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li class="dropdown dropdown-user dropdown-dark">
                                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="padding-top: 0px; padding-bottom: 0px; padding-left: 0px;">
                                         ...
                                         <asp:Label ID="lbltentid"  runat="server"  ></asp:Label>  <asp:Label ID="lblpageid"  runat="server"  ></asp:Label>
        ...
        <div class="page-container" style="padding-left: 5px; padding-top: 5px;">
            ...
            <div class="page-content-wrapper">
                <div class="page-content" style="padding-top: 0px;padding-left: 0px;">
                    ...
                    <iframe runat="server" id="ifrm" name="ifrm" frameborder="0" style="height: 660px; overflow: scroll; width: 100%"></iframe>
        ...
        <div class="page-footer">
            <div class="page-footer-inner">
                2014 &copy; Digital Edge Solutions.
            </div>
