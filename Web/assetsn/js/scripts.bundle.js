		...
		var handleMessaging = function() {
			...
			var html = 
				'<div class="kt-chat__user">' +				
					...
					'<span class="kt-media kt-media--circle kt-media--sm">' +
						'<img src="./assetsp/media/users/100_12.jpg" alt="image">'  + 
					'</span>' +
				'</div>' +
			...
			setTimeout(function() {
				...
				var html = 
					'<div class="kt-chat__user">' +
						'<span class="kt-media kt-media--circle kt-media--sm">' +
							'<img src="./assetsp/media/users/100_13.jpg" alt="image">'  + 
						'</span>' +
...
var KTDemoPanel = function() {
    ...
    var remind = function() {
        if (!(encodeURI(window.location.hostname) == 'pos53.com' || encodeURI(window.location.hostname) == 'www.pos53.com')) {
            return;
        }
...
var KTQuickSearch = function() {
    ...
    var processSearch = function() {
        ...
        setTimeout(function() {
            $.ajax({
                url: 'https://pos53.com/metronic/themes/themes/metronic/dist/preview/inc/api/quick_search.php',
                data: {
                    query: query
                },
                dataType: 'html',
